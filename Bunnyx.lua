  ...
  \ \  \____   /     \/   \ \  \ \  \ \  \\\  \ \  \\\  \ \  \\ \  \ 
   \ \_______\/  /\   \    \ \__\ \__\ \_______\ \_______\ \__\\ \__\
    \|_______/__/ /\ __\    \|__|\|__|\|_______|\|_______|\|__| \|__|
             |__|/ \|__|       
Bunny X - LXYO WAS HERE DISCORD : lxyodev#1111                                                                                                                                                                         
--]]
...
local Window = library:AddWindow("BUY KITTENASSIST - discord.gg/puppyware", {
...
CreditTAB:AddButton("deobfuscated by lxyodevelopment & lxhook", function(bool)
    setclipboard("lxyodev#1111")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("Buy Puppy & Kittenassist ware", function(bool)
    setclipboard("discord.gg/kittenassist")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
